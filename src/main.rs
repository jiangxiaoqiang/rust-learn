use crate::synctex::{
    ...
    synctex_scanner_new_with_output_file, synctex_scanner_next_result, synctex_node_visible_h, synctex_node_visible_v, synctex_node_visible_height, synctex_node_visible_width,
};
